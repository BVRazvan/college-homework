...
test_fun_array=(                                                      \
        test_sched      "Test init params"                      2   1 \
        test_sched      "Test init"                             2   1 \
        test_sched      "Test double init"                      2   1 \
        test_sched      "Test reinit"                           2   1 \
        test_sched      "Test end before init"                  2   1 \
