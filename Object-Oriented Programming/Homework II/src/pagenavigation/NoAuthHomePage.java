...
public final class NoAuthHomePage implements PageState {
    ...
    public NoAuthHomePage(final PageNavigator pageNavigator) {
        this.pageNavigator = pageNavigator;
    }
    ...
    public void goToRegPage(final ArrayNode output, final User actualUser, final Input input,
        ...
        this.pageNavigator.setPageState(this.pageNavigator.getRegPage());
    }

    @Override
    public void goToAuthPage(final ArrayNode output, final User actualUser, final Input input,
                             final Action action, final Deque<Action> actionDeque) {
        this.pageNavigator.setPageState(this.pageNavigator.getAuthPage());
    }
